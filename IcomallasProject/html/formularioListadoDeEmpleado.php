...
<body>
	...
	<div id="tablaListado">
    	...
    	<table class="display" id="listadoEmpleado">
        	<thead>
            	<tr>
                	<td width="30" ><b>ID</b></td>
                	<td width="160"><b>Nombre</b></td>
                	<td width="80"><b>Documento</b></td>
                	<td width="80"><b>Tipo De Cargo</b></td>
                	<td width="80"><b>Teléfono</b></td>
        	...
        	<?php
            	for($i=0; $i < count($respuesta); $i++)
				{
                	...
                	echo '<tr>
                        	...
                        	<td>'.$respuesta[$i]["tipoCargo"].'</td>
                        	<td>'.$respuesta[$i]["telefono"].'</td>
                        	<td>'.$respuesta[$i]["direccion"].'</td>';
			?>
                        	<td>
                        		<span class="accion-usuario" title="Consultar Empleado" onClick="accionEmpleado('<?php echo $id ?>', '2')">
                           			<img src="../images/consultar.png" />
                         		</span>
                        		<span class="accion-usuario" title="Editar Empleado" onClick="accionEmpleado('<?php echo $id ?>', '1')">
                           			<img src="../images/document.png" />
                         		</span>
                         		<span class="accion-usuario" title="Eliminar Empleado" onClick="accionEmpleado('<?php echo $id ?>', '3', this)">
