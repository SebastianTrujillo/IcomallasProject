...
<body>
	...
	<div id="tablaListado">
    	...
    	<table class="display" id="listadoUsuario">
        	<thead>
            	<tr>
                	<td width="30" ><b>ID</b></td>
                	<td width="160"><b>Empleado</b></td>
                	<td width="80"><b>Tipo De Permiso</b></td>
        	...
        	<?php
            	for($i=0; $i < count($respuesta); $i++)
				{
                	...
                	echo '<tr>
                        	...
                        	<td>'.$respuesta[$i]["tipoPermiso"].'</td>
                        	<td>'.$respuesta[$i]["nombreUsuario"].'</td>';
			?>
                        	<td>
                        		<span class="accion-usuario" title="Consultar Usuario" onClick="accionPerfil('<?php echo $id ?>', '2')">
                           			<img src="../images/consultar.png" />
                         		</span>
                        		<span class="accion-usuario" title="Editar Usuario" onClick="accionPerfil('<?php echo $id ?>', '1')">
                           			<img src="../images/document.png" />
                         		</span>
                         		<span class="accion-usuario" title="Eliminar Usuario" onClick="accionPerfil('<?php echo $id ?>', '3', this)">
