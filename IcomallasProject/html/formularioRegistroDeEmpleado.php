...
<body>
    ...
    <div id="contenedorInicio">
    	...
    	<div id="contenidoDePaginaInicio">
        	<form id="frm-empleado" class="form" onSubmit="enviarDatosEmpleado('insertar', event)">
            <!-------------------------------------------------------------------------------------------------------------------->
            <div class="field">
            ...
            <div class="field">
                ...
                <select name="tipoCargo" id="tipoCargo" title="Tipo De Cargo" class="requerido">
                	
            		<script>llenarCombo('tipoCargo', 'tipoCargo');</script>
            	</select>               
            </div>    
            <!-------------------------------------------------------------------------------------------------------------------->
            <div class="field">
