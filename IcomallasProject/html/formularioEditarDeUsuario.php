...
<body>
    ...
    <div id="contenedorInicio">
    	...
    	<div id="contenidoDePaginaInicio">
        	<form id="frm-usuario" class="form" onSubmit="enviarDatosUsuario('modificar', event)">
            ...
            <div id="empleado">
                ...
                <input type="text" name="nombres" id="nombres"title="Nombre Completo:" readonly style="background-color:rgb(249,249,249); border:none;"/>               
            </div>
            <!-------------------------------------------------------------------------------------------------------------------->
            <div class="field">
                <label for="documento">Numero De Documento:</label>
                <input type="text" name="documento" id="documento"title="Numero De Documento" readonly style="background-color:rgb(249,249,249); border:none;"/>               
            </div>
            ...
            <div class="field">
                ...
                <select name="tipoDePermiso" id="tipoPermiso" title="Tipo De Permiso" class="requerido"></select>    
            </div>
            <!-------------------------------------------------------------------------------------------------------------------->
            <div class="field">
                ...
                <input type="text" name="Usuario" id="Usuario"title="Usuario" class="requerido" />               
            </div>
